...
#     element_visibility, wait_for_long_load, element_to_be_clickable
...
#         return element_visibility(self.wait, BuildPageLocators.CONFIG_SEARCH_FIELD)
#
#     def use_custom_config(self):
#         return element_to_be_clickable(self.wait, BuildPageLocators.CUSTOM_MODEL_CONFIG)
#
...
#         return element_visibility(self.wait, BuildPageLocators.EDIT_MODAL)
#
#     def find_default_config_name(self):
#         return element_visibility(self.wait, BuildPageLocators.CONFIG_TEXT_FIELD_NAME)
#
#     def set_your_config_name(self):
#         return element_visibility(self.wait, BuildPageLocators.CHANGE_CONFIG_NAME_TEXT_FIELD)
#
#     def clear_default_description_name(self):
#         return element_visibility(self.wait, BuildPageLocators.DESCRIPTION)
#
...
#         element_to_be_clickable(self.wait, BuildPageLocators.BTN_START_EDITING)
...
#         expected_url = f"https://bbp.epfl.ch/mmb-beta/build/cell-composition/interactive" \
