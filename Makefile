...
production:
	...
	# uv run pytest tests/test_landing.py tests/test_login.py tests/test_explore_page.py tests/test_morphology.py tests/test_explore_ephys.py tests/test_explore_ndensity.py tests/test_explore_emodel.py tests/test_build.py --env=production --env_url=production --browser-name=firefox $(HEADLESS) -sv
	 uv run pytest tests/test_about.py tests/test_landing.py tests/test_login.py tests/test_explore_ndensity.py tests/test_explore_emodel.py tests/test_build.py --env=production --env_url=production --browser-name=firefox $(HEADLESS) -sv
...
staging:
	...
	uv run pytest tests/test_landing.py tests/test_about.py tests/test_login.py tests/test_explore_ndensity.py tests/test_explore_emodel.py tests/test_build.py --env=staging --env_url=staging --browser-name=firefox $(HEADLESS) -sv
	#uv run pytest tests/test_login.py tests/test_morphology.py tests/test_explore_ephys.py tests/test_explore_ndensity.py tests/test_explore_emodel.py tests/test_build.py --env=staging --env_url=staging --browser-name=firefox $(HEADLESS) -sv
