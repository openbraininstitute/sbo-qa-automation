...
class ExploreEModelPageLocators:
    ...
    DV_REGISTERED_BY_LABEL = (By.XPATH, "//div[normalize-space()='Registered by']")
    DV_REGISTERED_BY_VALUE = (By.XPATH, "//div[normalize-space()='Registered by']/following-sibling::div")
