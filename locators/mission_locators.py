...
class MissionLocators:
    ...
    MAIN_HERO_VIDEO = (By.CSS_SELECTOR, ".Hero-module__E0OG9W__show")
    MISSION_PAGE_TITLE = (By.XPATH, "//div[starts-with(@class,'Hero-module__E0OG9W__text')]//h1[text()='Mission']")
    MISSION_MAIN_TEXT = (By.XPATH, "//div[starts-with(@class,'Hero-module__E0OG9W__content') and contains(text(), 'The Open Brain Institute')]")
    MAIN_TITLES = (By.XPATH, "//h1[starts-with(@class,'styles_blockSmall')]")
    MAIN_PAGE_PARAGRAPH = (By.XPATH, "(//div[starts-with(@class, 'Text-module__KTJYiG__text')])[1]")
    MINOR_PAGE_PARAGRAPH = (By.XPATH, "(//div[starts-with(@class, 'Text-module__KTJYiG__text')])[2]")
    MODELS_CARDS = (By.XPATH, "//div[starts-with(@class,'swipeable-cards-list_scroll')]")
    PLATFORM_SECTIONS = (By.XPATH, "//div[starts-with(@class, 'VirtualLabsPanel-module')]")
    PDF_NEW_TAB = (By.LINK_TEXT, "https://cdn.sanity.io/files/fgi7eh1v/staging/6c892e090449e62ffaa03aaabb47e582fb8dacee.pdf")
    P_SECTION_TITLES = (By.XPATH, "//ul[starts-with(@class,'SanityContentItems')]//li//h3")
    P_SECTION_TEXTS = (By.XPATH, "//ul[starts-with(@class,'SanityContentItems')]//li//div[last()]")
    P_SECTION_IMAGES = (By.XPATH, "//ul[starts-with(@class,'SanityContentItems')]//li//img")
