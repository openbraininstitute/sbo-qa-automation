...
class BuildPageLocators:
    ...
    CUSTOM_MODEL_CONFIG = (By.XPATH, "//tbody/tr/td[@class='ant-table-cell' and contains(text(), 'Custom model "
                                     "configuration.')]")
    # BTN_CLONE_CONFIG = (By.XPATH, "//tbody[@class='ant-table-tbody']/tr[@class ='ant-table-row "
    #                               "ant-table-row-level-0'][1]/td[4]/button[2]")
    BTN_CLONE_CONFIG = (By.XPATH, "//tr[2]/td[contains(text(), 'Custom model configuration')]/following-sibling::td//button[2]")
