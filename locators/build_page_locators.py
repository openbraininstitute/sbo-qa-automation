...
class BuildPageLocators:
    ...
    BUILD_AND_SIMULATE_BUTTON = (By.XPATH, "//div[@class='flex']/button[@type='button' and text()='Build & Simulate']")
    ...
    SECOND_SUB_MENU = (By.XPATH, "//button[@type='button' and starts-with(@class,'min-w-[190px]')]/div[starts-with(@class,'flex flex-row')]/*[name()='svg']")
    TOP_NAV_MENU = (By.XPATH, "//button[@type='button' and @aria-haspopup='menu']//div[contains(text(), 'Cell composition')]")
    CELL_COMPOSITION = (By.XPATH, "//div[@role='menu']//div[contains(text(),'Cell composition')]")
    CELL_MODEL_ASSIGNMENT = (By.XPATH, "//div[@role='menu']//div[contains(text(),'Cell model assignment')]")
    CONNECTOME_DEFINITION = (By.XPATH, "//div[@role='menu']//div[contains(text(),'Connectome definition')]")
    CONNECTION_MODEL_ASSIGNMENT = (By.XPATH, "//div[@role='menu']//div[contains(text(),'Connection model assignment')]")
    TOP_SUB_MENU = (By.XPATH, "//button[@type='button' and starts-with(@class, 'min-w-[190px] h-full border-l border-neutral')]/div[contains(text(), 'Interactive')]")
