...
class BuildPageLocators:
    ...
    BASIC_CELL_GROUPS_AND_REGIONS = (By.XPATH, "//span[contains(text(),'Basic cell groups and "
                                               "regions')]")
    SEARCH_INPUT = (By.XPATH, "//input[@aria-label='Search']")
    SEARCH_VALUE = (By.XPATH, "//div[@class='ant-select-item-option-content' and contains(text(), "
                              "'Isocortex')]")
    ...
    BRAIN_BUILD_CLOSED_DIV = (By.XPATH, "//div[@data-tree-id='8']//button[@type='button'][3]")
    VISIBLE_BASIC_CELL_GROUPS_TEXT = (By.XPATH, "//span[text()='Basic cell groups and regions']")
    BASIC_CELL_GROUPS_ARROW_BTN = (
        By.XPATH,
        "//div[@class='py-3 flex items-center justify-between']//button[3]//*[name()='svg']")
    ...
    TOP_SUB_MENU = (By.XPATH, "//button[@type='button' and starts-with(@class, 'min-w-[190px] "
                              ...
                              "'Interactive')]")
    SUB_MENU_CONFIGURATION = (By.XPATH, "//button[@type='button' and @role='menuitem' and "
